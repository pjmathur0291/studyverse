                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12 mb-4 mb-lg-0 d-flex align-items-center">
                        <div class="services-info">
                            ...
                            <p class="text-white">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit explicabo eum similique accusantium quisquam beatae corporis dolorum, id labore natus asperiores eligendi, amet placeat ipsum libero hic dicta sapiente ipsam.
                            </p>

                            <h6 class="text-white mt-4">Whole Night Study</h6>

                            <p class="text-white">
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Inventore corporis corrupti consequuntur nobis natus soluta cumque minima molestias facere repellendus? Qui aliquam repellat nostrum et veniam atque vero rerum odit!
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="about-text-wrap">
                            <img src="images/pexels-william-fortunato-6140697.jpg" class="about-image img-fluid">
                            ...
                            <div class="about-text-info d-flex">
                                ...
                                <div class="ms-4 text-capitalize">
                                    <h3>a happy moment with unknown people</h3>

                                    <p class="mb-0">your amazing online study experience with us and others</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="col-12 text-center">
                        <h2 class="mb-4">What We Offer?</h1>
                    </div>

                    <div class="col-lg-5 col-12">
                        <div class="artists-thumb">
                            <div class="artists-image-wrap">
                                <img src="images/books-imagination-still-life.jpg" class="artists-image img-fluid">
                            </div>

                            <div class="artists-hover">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui provident, illum fugiat saepe et quasi magni velit autem voluptatum eveniet fugit adipisci labore suscipit magnam impedit omnis odit nesciunt nam?
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5 col-12">
                        <div class="artists-thumb">
                            <div class="artists-image-wrap">
                                <img src="images/video_conferencing_remote_work_online_meeting_by_rlt_images_gettyimages-1219032156_2400x1600_cw-100839430-large.webp" class="artists-image img-fluid">
                            </div>

                            <div class="artists-hover">
                                
                                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. A, voluptatum. Eaque, iste aperiam magni magnam architecto ab et adipisci totam. Magni saepe fugiat magnam vero dolorum quod aut earum alias neque optio.
                                
                            </div>
                        </div>

                        <div class="artists-thumb special" style="border: 5px solid black; border-radius: var(--border-radius-medium);">
                            <img src="images/1511848671.webp" class="artists-image img-fluid">
        ...
        <section class="schedule-section section-padding" id="section_4">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 text-center">
                        <h2 class="text-white mb-4">Schedule your Daily Study Plan</h1>
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="pricing-thumb">
                            ...
                            <ul class="pricing-list mt-3">
                                <li class="pricing-list-item">platform for potential <br/>learners</li>
                                ...
                                <form class="custom-form contact-form mb-5 mb-lg-0" action="#" method="post" role="form">
                                    <div class="contact-form-body">
                                        ...
                                        <div class="col-lg-4 col-md-10 col-8 mx-auto">
                                            <button type="submit" name="form_contact_submit_btn" class="form-control">Send message</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
